<?php
	...
	$Translation['add group'] = "Agregar usuarios";
	$Translation['edit anonymous permissions'] = "Editar permisos";
	...
	$Translation["add new group"] = "Agregar nuevo grup";
	...
	$Translation['import CSV to database page'] = "Esta página le permite cargar un archivo CSV (por ejemplo, uno generado desde MS Excel) e importarlo a una de las tablas de la base de datos. Esto hace que sea muy fácil rellenar la base de datos con datos de otras fuentes en lugar de ingresar manualmente cada registro .";
	$Translation['populate table from CSV'] = "Esta es la tabla que desea rellenar con datos del archivo CSV.";
	...
	$Translation['search groups'] = "Buscar";
	$Translation['find'] = "Buscar";
	$Translation['reset'] = "borrar";
	$Translation['members count'] = "Usuario";
	...
	$Translation['displaying groups'] = "Mostrar grupo <GROUPNUM1> de <GROUPNUM2>  <GROUPS>";
	$Translation['next'] = "Siguiente";
	$Translation['key'] = "Key:";	
	$Translation['edit group details'] = "Editar grupo";
	$Translation['add member to group'] = "Agregar grupo.";
	...
	//pageViewMembers.php
	$Translation['search members'] = "Buscar <SEARCH> in <HTMLSELECT>";
	$Translation['all fields'] = "todos";
	$Translation['any'] = "Any";
	$Translation['waiting approval'] = "En espera";
	$Translation['active'] = "Activo";
	$Translation['Banned'] = "Cancelado";
	$Translation['username'] = "Usuario";
	$Translation['sign up date'] = "Fecha de registro";
	$Translation['Status'] = "Estatus";
	$Translation['Edit member'] = "Editar usuario";	
	$Translation['sure delete user'] = "¿Estás seguro de que deseas eliminar el usuario? \'<USERNAME>\'?";
	...
	$Translation['no file chosen yet'] = 'Aún no hay archivos elegidos';
