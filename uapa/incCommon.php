	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(
			...
			'Cotrol_Acad' => array('Control Acad&#233;mico', '', 'resources/table_icons/application_view_detail.png', 'None'),
			'inscripciones' => array('Inscripci&#243;n', '', 'resources/table_icons/accept.png', 'None'),
			'Aulas' => array('Aulas', '', 'resources/table_icons/arrow_branch.png', 'None')
		);
	...
	function get_sql_fields($table_name){
		$sql_fields = array(   
			'Cotrol_Acad' => "`Cotrol_Acad`.`id` as 'id', `Cotrol_Acad`.`Codigo` as 'Codigo', `Cotrol_Acad`.`Seccion` as 'Seccion', `Cotrol_Acad`.`Nombre` as 'Nombre', `Cotrol_Acad`.`Aula` as 'Aula', `Cotrol_Acad`.`Dia` as 'Dia', `Cotrol_Acad`.`Hora_Inicio` as 'Hora_Inicio', `Cotrol_Acad`.`Hora_Final` as 'Hora_Final', `Cotrol_Acad`.`Fecha_inicion` as 'Fecha_inicion', `Cotrol_Acad`.`Facilitador` as 'Facilitador', `Cotrol_Acad`.`mapa` as 'mapa', `Cotrol_Acad`.`mapa_link` as 'mapa_link'",
			'inscripciones' => "`inscripciones`.`id` as 'id', `inscripciones`.`Codigo` as 'Codigo', `inscripciones`.`Seccion` as 'Seccion', `inscripciones`.`Periodo` as 'Periodo', `inscripciones`.`Matricula` as 'Matricula'",
			'Aulas' => "`Aulas`.`id` as 'id', `Aulas`.`Nombre` as 'Nombre', `Aulas`.`numero` as 'numero', `Aulas`.`Campus` as 'Campus', `Aulas`.`mapa` as 'mapa'"
		);
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> Control Aulas</a>
			</div>
...
EOT;
	...
	function StyleSheet(){
		...
		$css_links = <<<EOT
			...
			<link rel="stylesheet" href="{$prepend_path}resources/initializr/css/uapa6.css">
